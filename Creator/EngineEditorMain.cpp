...
struct EngineEditorMain::Impl
{
	...
	void AddWorldViewers(const RenderEngineMain* renderEngineMain)
	{
		...
		{
			auto fbo = renderEngineMain->GetFboBuffer(r2v.WorldFboName, r2v.fboIndex, r2v.bufferIndex);
			...
			engineUI.AddWorldViewers(fbo, r2v.viewerName, static_cast<WorldViewerType>(r2v.viewerType), selectCallback);
		}
	}
...
void EngineEditorMain::AddWorldViewers(const RenderEngineMain* renderEngineMain)
{
	Pimpl()->AddWorldViewers(renderEngineMain);
}
